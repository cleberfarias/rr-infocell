...
export default function AnimatedStepper({
  ...
  return (
    ...
    >
          ...
          return (
            ...
            >
              <motion.button
                ...
                className={cn(
                  "smooth-step-button relative flex h-10 w-10 shrink-0 items-center justify-center rounded-full border-2 font-medium text-sm",
              ...
              {isHorizontal && (
                <div className="smooth-step-meta ml-2 hidden sm:block">
                  <p
                    className={cn(
              ...
              {isHorizontal && index < steps.length - 1 && (
                <div className="smooth-step-track mx-2 h-0.5 flex-1 overflow-hidden rounded-full bg-muted">
                  <motion.div
                    animate={{ width: index < activeStep ? "100%" : "0%" }}
                    className="smooth-step-fill h-full bg-primary"
                    transition={shouldReduceMotion ? { duration: 0 } : SPRING}
                  />
                </div>
              )}
      ...
      <div className="smooth-step-panel" aria-label={`Step ${activeStep + 1} content`} role="tabpanel">
        <AnimatePresence initial={false} mode="wait">
          <motion.div
