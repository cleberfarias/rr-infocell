...
export const produtoInputSchema = z.object({
  ...
  categoria: z.enum(["peca", "produto", "acessorio", "servico", "celular_novo", "celular_seminovo", "celular_restaurado"]),
  estoqueAtual: stock,
  estoqueMinimo: stock,
  custo: money,
  precoVenda: money,
...
export const produtoSearchSchema = z.object({
  ...
  categoria: z
    .enum(["peca", "produto", "acessorio", "servico", "celular_novo", "celular_seminovo", "celular_restaurado"])
    .optional()
    .or(z.literal(""))
    .default(""),
